...
namespace Mfpe\ConfigBundle\Serializer;

use Mfpe\ConfigBundle\Annotation\DeserializeEntity;
//use Doctrine\Bundle\DoctrineBundle\Registry;
use Doctrine\Common\Persistence\ManagerRegistry as Registry;
...
class DoctrineEntityDeserializationSubscriber implements EventSubscriberInterface
{
    ...
    {
        //dump($event->getType(),$event->getData());exit;
